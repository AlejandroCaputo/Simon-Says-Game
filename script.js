...
//con bind podemos cambiar quie es el this
    ...
    ganoElJuego(){
        swal(`Yeahhhh`,`Ganaste el videojuego!`,`success`)
            .then(()=> {
                this.inicializar()
            })
    }
    ...
    perdioElJuego(){
        swal(`Upsss`,`Perdiste el juego!`,`error`)
            .then(()=> {
                this.eliminarEventosClick()
                this.inicializar()
            })
